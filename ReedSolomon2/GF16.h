...
namespace ReedSolomon
{
	...
	extern "C" {
		__declspec(dllexport) uint16_t GF16_Multiply(uint16_t x, uint16_t y);
		__declspec(dllexport) uint16_t GF16_Add(uint16_t x, uint16_t y);
		__declspec(dllexport) uint16_t GF16_Inverse(uint16_t x);
		__declspec(dllexport) uint16_t GF16_Power(uint16_t x, int a);
		__declspec(dllexport) uint16_t GF16_Exp(int a);
		__declspec(dllexport) int GF16_Log(uint16_t x);
	}
}
